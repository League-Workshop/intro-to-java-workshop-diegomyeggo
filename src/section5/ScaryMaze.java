...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Coolest Maze.jpg"));
		//2. Change the line of code above so that it matches your maze's file name
		
		//3. Set the mouse pointer to the start of your maze using: 317 is hard 212 is easy
		new Robot().mouseMove(30, 317);
